...
source("../code/stocks_parametricVaR.R")
...
#Backtest
GvaR_BT<-BackTest(s1,Gvar,5,10000)
plotGraph(GvaRPBT,XOM$Dates)
...
#Back Test
GvaR_BT<-BackTest(portfolio_price,Gvar,5,10000)
BTplot(GvaR_BT,INTC$Dates)
...
PvaR_BT<-BackTest(portfolio_price,PVaR,5,10000)
BTplot(PvaR_BT,INTC$Dates)
...
Portfolio
1.Historical VaR (stocks+option)
  a.how to calculate Profit & Loss?

2.Parametric VaR (underlying stocks follow GBM)
  a.two stocks + need revise the function,the plot seems not correct
  b.3 stocks, how to construct covariance matrix?
  c.stocks+options

3.Monte Carlo VaR
  a.two stocks(construct rho and w1,w2)
  b.stocks+options
